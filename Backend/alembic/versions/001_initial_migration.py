"""Initial database schema for JobMatch."""
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("user_id", "external_job_id", name="uq_user_external_job"),
    )
    op.create_index(op.f("ix_saved_jobs_external_job_id"), "saved_jobs", ["external_job_id"], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_saved_jobs_external_job_id"), table_name="saved_jobs")
